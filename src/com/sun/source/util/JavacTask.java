...
public abstract class JavacTask implements CompilationTask {
    ...
    public static JavacTask instance(ProcessingEnvironment processingEnvironment) {
		 ...
		 * "com.sun.tools.javac.processing.JavacProcessingEnvironment")) throw
		 * new IllegalArgumentException(); Context c =
		 * ((JavacProcessingEnvironment) processingEnvironment).getContext();
		 * JavacTask t = c.get(JavacTask.class); return (t != null) ? t : new
		 * JavacTask(c, true);
		 */
    	return null;
    }
