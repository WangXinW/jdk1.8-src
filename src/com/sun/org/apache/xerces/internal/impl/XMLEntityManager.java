...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    public String setupCurrentEntity(String name, XMLInputSource xmlInputSource,
         ...
         */
        fCurrentEntity = new com.sun.xml.internal.stream.Entity.ScannedEntity(isBigEndian, name,new XMLResourceIdentifierImpl(publicId, literalSystemId, baseSystemId, expandedSystemId),stream, reader, encoding, literal, encodingExternallySpecified, isExternal);
