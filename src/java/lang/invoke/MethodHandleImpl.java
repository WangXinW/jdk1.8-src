...
/*non-public*/ abstract class MethodHandleImpl {
        ...
        for (int i = 0; i < INARG_COUNT; i++) {
            ...
            if (src.isPrimitive()) {
                if (dst.isPrimitive()) {
                    ...
                    MethodHandle boxMethod = ValueConversions.boxExact(w);
                ...
                if (dst.isPrimitive()) {
                    ...
                    if (level == 0 || VerifyType.isNullConversion(src, w.wrapperType(), retConv)) {
                        fn = ValueConversions.unboxCast(dst);
                        ...
                        MethodHandle unboxMethod = (level == 1
                                                    ...
                                                    : ValueConversions.unboxExact(dst));
                        fn = unboxMethod;
                    } else {
                        // Example: Byte->int
    ...
    static class AsVarargsCollector extends MethodHandle {
        ...
        MethodHandle permuteArguments(MethodType newType, int[] reorder) {
            return ((AsVarargsCollector) asFixedArity()).permuteArguments(newType, reorder);
        }
    }
